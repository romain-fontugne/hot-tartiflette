...
class Plotter(object):
    ...
    def freqRMSscatterplot(self):
        ...
        axScatter.set_xticks([1.0/(3600*24*30), 1.0/(3600*24*7*2), 1.0/(3600*24*7), 1.0/(3600*24*3), 1.0/(3600*24), 1.0/(3600*6)])
        ...
        axScatter.set_yticks([10, 50, 100])
        axScatter.set_yticklabels(["10ms", "50ms", "100ms"])
